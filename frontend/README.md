...
src/
├── api/
│   └── client.js               # Axios instance & API setup
│
...
│   ├── MainLayout.vue          # Default layout with navbar/footer
│   └── AuthLayout.vue          # Auth pages layout
│
├── pages/                      # Page components (matched by router)
│   ├── HomePage.vue            # Landing page
│   ├── ProductsPage.vue        # Products listing
│   ├── ProductDetailPage.vue   # Single product detail
│   ├── CartPage.vue            # Shopping cart
│   ├── CheckoutPage.vue        # Checkout form
│   ├── RegisterPage.vue        # User registration
│   ├── LoginPage.vue           # User login
│   ├── ProfilePage.vue         # User profile
│   ├── AdminDashboard.vue      # Admin dashboard
│   ├── ProductsManagement.vue  # Manage products (admin)
│   ├── TenantsManagement.vue   # Manage tenants (admin)
│   └── NotFound.vue            # 404 page
│
├── router/
│   └── index.js                # Router configuration & routes
│
